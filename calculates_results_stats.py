...
def calculates_results_stats(results_dic):
    ...
    # initialisation of the keys and values of the dictionary
    ...
    for key in results_dic:
        ...
        # match (dog = dog) or (not dog = not dog)
        if results_dic[key][2] == 1:
            results_stats_dic['n_match'] += 1
            # is a dog
            if results_dic[key][3] == 1:
                results_stats_dic['n_dogs_img'] += 1
                # dog classified as a dog
                # dog breed is correct
        ...
        # is NOT a match
            ...
            # is NOT a dog
                ...
                results_stats_dic['n_notdogs_img'] += 1
                # is NOT classified as dog
                if results_dic[key][4] == 0:
                    results_stats_dic['n_correct_notdogs'] += 1
        
    # percentage of correct matches over the number of images
    results_stats_dic['pct_match'] = results_stats_dic['n_match'] / results_stats_dic['n_images'] * 100
    # percentage of correctly classified dogs over the number of dog images
    results_stats_dic['pct_correct_dogs'] = results_stats_dic['n_correct_dogs'] / results_stats_dic['n_dogs_img'] * 100
    # percentage of correctly classified dog breeds over the number of dog images
    results_stats_dic['pct_correct_breed'] = results_stats_dic['n_correct_breed'] / results_stats_dic['n_dogs_img'] * 100
    # percentage of correctly classified NON-dogs over the number of non-dog images
